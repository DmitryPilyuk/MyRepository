...
#### 4.   Add
Если пользователь находится внутри категории, добавляет задачу принимая на вход строку формата dd.mm.yyyy <Name of task>.
Если пользователь находится в списке категорий, добавляет новую категорию, принипая на вход название категории.
#### 5.   Delete
